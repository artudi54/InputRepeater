...
OptionsDialog::OptionsDialog(const Options &options, QWidget *parent)
	...
	QObject::connect(ui.buttonOpenDir, &QPushButton::clicked, this, &OptionsDialog::open_records_dir);
...
void OptionsDialog::open_records_dir() {
	QDesktopServices::openUrl(QUrl::fromLocalFile(QStringLiteral("Records")));
}
